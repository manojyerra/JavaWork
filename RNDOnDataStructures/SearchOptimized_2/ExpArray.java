...
{	
	...
	private synchronized void removeKey(Object obj)
	{
		if(map.containsKey(obj))
		{
			...
			{
				map.put(obj, new Integer(value.intValue()-1));
			}
		}		
	}
	
	private synchronized void addKey(Object obj)
	{
		if(map.containsKey(obj))
		{
			Integer value = map.get(obj);
